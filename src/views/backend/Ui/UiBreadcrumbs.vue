              ...
              <div class="card">
                <kbd class="bg-dark">
                  <pre class="text-white" id="breadcrumb-icon-3">
                    <code>
&lt;b-breadcrumb class="mm-bg-primary" :items="itemsIcon1" /&gt;
&lt;b-breadcrumb class="mm-bg-primary" :items="itemsIcon2" /&gt;
&lt;b-breadcrumb class="mm-bg-primary" :items="itemsIcon3" /&gt;
      ...
      itemsIcon3: [
        ...
        },
        {
          ...
          active: true
             ...
             <b-breadcrumb class="mm-bg-primary" :items="itemsIcon1" />
             <b-breadcrumb class="mm-bg-primary" :items="itemsIcon2" />
             <b-breadcrumb class="mm-bg-primary mb-0" :items="itemsIcon3" />
          </template>
        </card>
      </b-col>
      <b-col lg="12" sm="12">
