	...
	<div class="row">
		<div class="col-lg-12 mb-3">
			<div class="d-flex align-items-center justify-content-between welcome-content">
				<div class="navbar-breadcrumb">
					<h4 class="mb-0 font-weight-700">Welcome To Dashboard</h4> </div>
				<div class=""> <a class="btn btn-primary button-icon" target="_blank" href="#">View Detail</a> </div>
			</div>
		</div>
		<div class="col-lg-12">
			<div class="row">
			...
			<div class="row">
					...
					<div class="card card-block card-stretch card-height">
						<div class="card-header d-flex justify-content-between">
							<div class="header-title">
								<h4 class="card-title">Statistics</h4> </div>
							<div class="card-header-toolbar d-flex align-items-center">
								<b-dropdown id="dropdownMenuButton1" right variant="none p-0" data-toggle="dropdown" class="dropdown shadow-none">
									<template v-slot:button-content> <span class="dropdown-tog   gle dropdown-bg btn btn-outline-primary" id="dropdownMenuButton4" data-toggle="dropdown" aria-expanded="false">
						...
						<div class="card-body">
							<ApexChart element="chart-01" :chartOption="chart1" /> </div>
					</div>
				</div>
				<div class="col-lg-4 col-md-6">
					<div class="card card-block card-stretch card-height rule-box">
						<div class="card-header d-flex justify-content-between">
							<div class="header-title">
								<h4 class="card-title">IP Exclusions</h4> </div>
							<div class="card-header-toolbar d-flex align-items-center"> <a href="#" class="btn btn-outline-primary view-more">View More</a> </div>
						</div>
						<div class="card-body">
							<ul class="perfomer-lists m-0 p-0">
								<li class="d-flex mb-3 align-items-center">
									...
									<div class="card-header-toolbar d-flex align-items-center">
										<h4 class="text-danger"><b>268</b></h4> </div>
								</li>
								<li class="d-flex mb-3 align-items-center">
									<div class="top-block-one d-flex align-items-center justify-content-between">
										<div class="bg-info icon mm-icon-box mr-0 rounded">
											<svg class="svg-icon fill-none" width="35" height="35" id="d-1-c" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
												<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 15l-2 5L9 9l11 4-5 2zm0 0l5 5M7.188 2.239l.777 2.897M5.136 7.965l-2.898-.777M13.95 4.05l-2.122 2.122m-5.657 5.656l-2.12 2.122" /> </svg>
										</div>
									</div>
									<div class="media-support-info ml-3">
									...
									<div class="card-header-toolbar d-flex align-items-center">
										<h4 class="text-danger"><b>4342</b></h4> </div>
								</li>
								<li class="d-flex mb-3 align-items-center">
									<div class="top-block-one d-flex align-items-center justify-content-between">
										<div class="bg-skyblue icon mm-icon-box mr-0 rounded">
											<svg class="svg-icon fill-none" width="35" height="35" id="d-1-p" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
												<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" /> </svg>
										</div>
									</div>
									<div class="media-support-info ml-3">
									...
									<div class="card-header-toolbar d-flex align-items-center">
										<h4 class="text-danger"><b>6565</b></h4> </div>
								</li>
								<li class="d-flex mb-3 align-items-center">
									<div class="top-block-one d-flex align-items-center justify-content-between">
										<div class="bg-info icon mm-icon-box mr-0 rounded">
											<svg class="svg-icon fill-none" width="35" height="35" id="d-1-e" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
												<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 15l-2 5L9 9l11 4-5 2zm0 0l5 5M7.188 2.239l.777 2.897M5.136 7.965l-2.898-.777M13.95 4.05l-2.122 2.122m-5.657 5.656l-2.12 2.122" /> </svg>
										</div>
									</div>
									<div class="media-support-info ml-3">
								...
								<li class="d-flex  align-items-center">
									<div class="top-block-one d-flex align-items-center justify-content-between">
										<div class="bg-success icon mm-icon-box mr-0 rounded">
											<svg class="svg-icon fill-none" width="35" height="35" id="d-1-m" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
									...
									<div class="card-header-toolbar d-flex align-items-center">
										<h4 class="text-danger"><b>32423</b></h4> </div>
								</li>
							</ul>
						</div>
					</div>
		...
		<div class="col-lg-6">
			<div class="card card-block card-stretch card-height">
				<div class="card-header d-flex justify-content-between">
					<div class="header-title">
						<h4 class="card-title">User's Progress</h4> </div>
					<div class="card-header-toolbar d-flex align-items-center">
						<b-dropdown id="dropdownMenuButton1" right variant="none p-0" data-toggle="dropdown" class="dropdown shadow-none">
							<template v-slot:button-content> <span class="dropdown-tog   gle dropdown-bg btn btn-outline-primary" id="dropdownMenuButton4" data-toggle="dropdown" aria-expanded="false">
                                    Monthly<i class="ri-arrow-down-s-line ml-1"></i>
				...
				<div class="card-body align-items-center">
					<ApexChart element="dash-chart-03" :chartOption="chart2" />
					<div class="mt-1 p-0 list-inline text-center data-indicator d-flex justify-content-center">
						<div class="">
							<div class="d-flex align-items-center"> <i class="ri-checkbox-blank-circle-fill text-primary"></i>
								<h2 class="line-height ml-2"><b>84</b></h2> </div>
							<p class="mb-0">Your Points</p>
						</div>
						<div class="ml-3">
							<div class="d-flex align-items-center"> <i class="ri-checkbox-blank-circle-fill text-info"></i>
								<h2 class="line-height ml-2"><b>64</b></h2> </div>
		...
		<div class="col-lg-6">
			<div class="card card-block card-stretch card-height">
				<div class="card-header d-flex justify-content-between">
					<div class="header-title">
						<h4 class="card-title">Upcoming Events</h4> </div>
					<div class="card-header-toolbar d-flex align-items-center"> <a href="#" class="btn btn-outline-primary view-more">View More</a> </div>
				</div>
				<div class="card-body">
					<ul class="list-inline p-0 m-0">
						<li class="d-flex align-items-center justify-content-between pb-3 border-bottom">
							...
							<div class="d-flex align-items-center font-size-18"> <span class="mr-2"><i class="ri-edit-box-line"></i></span> <span><i class="ri-delete-bin-line text-danger"></i></span> </div>
						</li>
		...
		<div class="col-lg-4">
			<div class="card card-block card-stretch card-height">
				<div class="card-header d-flex justify-content-between">
					<div class="header-title">
						<h4 class="card-title">Top Performers</h4> </div>
					<div class="card-header-toolbar d-flex align-items-center"> <a href="#" class="btn btn-outline-primary view-more">View More</a> </div>
				</div>
				<div class="card-body">
					<ul class="list-inline p-0 m-0">
						<li class="media align-items-start">
							<a href="javascript:void(0);"><img src="@/assets/images/user/1.jpg" class="img-fluid avatar-60 rounded-small" alt="image"></a>
							<div class="media-body ml-3">
								<div class="d-flex justify-content-between">
									<h5>Julia Met</h5> <span class="text-danger font-size-14">23 Jun 2020</span> </div> <span class="text-primary">New York</span> </div>
						</li>
						<li class="media align-items-start mt-3">
							<a href="javascript:void(0);"><img src="@/assets/images/user/5.jpg" class="img-fluid avatar-60 rounded-small" alt="image"></a>
							<div class="media-body ml-3">
								<div class="d-flex justify-content-between">
									<h5>Carolina Tens</h5> <span class="text-danger font-size-14">18 Dec 2020</span> </div> <span class="text-primary">California</span> </div>
						</li>
						<li class="media align-items-start mt-3">
							<a href="javascript:void(0);"><img src="@/assets/images/user/4.jpg" class="img-fluid avatar-60 rounded-small" alt="image"></a>
							<div class="media-body ml-3">
								<div class="d-flex justify-content-between">
									<h5>Anna Mull</h5> <span class="text-danger font-size-14">23 Aug 2020</span> </div> <span class="text-primary">Indiana</span> </div>
						</li>
						<li class="media align-items-start mt-3">
							<a href="javascript:void(0);"><img src="@/assets/images/user/5.jpg" class="img-fluid avatar-60 rounded-small" alt="image"></a>
							<div class="media-body ml-3">
								<div class="d-flex justify-content-between">
									<h5>Joan Watson</h5> <span class="text-danger font-size-14">31 Dec 2020</span> </div> <span class="text-primary">Chicago</span> </div>
						</li>
					</ul>
				</div>
			</div>
		...
		<div class="col-lg-4">
			<div class="card card-block card-stretch card-height">
				<div class="card-header d-flex justify-content-between">
					<div class="header-title">
						<h4 class="card-title">Social Media</h4> </div>
					<div class="card-header-toolbar d-flex align-items-center"> <a href="#" class="btn btn-outline-primary view-more">View More</a> </div>
				</div>
				<div class="card-body">
					<ApexChart element="dash-chart-02" :chartOption="chart3" /> </div>
			</div>
		</div>
		<div class="col-lg-4">
			<div class="card card-block card-stretch card-height">
				<div class="card-header d-flex justify-content-between">
					<div class="header-title">
						<h4 class="card-title">Products</h4> </div>
					<div class="card-header-toolbar d-flex align-items-center"> <a href="#" class="btn btn-outline-primary view-more">View More</a> </div>
				</div>
				<div class="card-body">
					<ul class="list-inline p-0 m-0">
						<li class="media align-items-center">
							<a href="javascript:void(0);"><img src="@/assets/images/layouts/layout-1/prod-1.jpg" class="img-fluid avatar-60 rounded-small" alt="image"></a>
							<div class="media-body ml-3">
								<h5>Full Tees</h5>
						...
						<li class="media align-items-center mt-3">
							<a href="javascript:void(0);"><img src="@/assets/images/layouts/layout-1/prod-2.jpg" class="img-fluid avatar-60 rounded-small" alt="image"></a>
							<div class="media-body ml-3">
								<h5>Denim Jeans</h5>
						...
						<li class="media align-items-center mt-3">
							<a href="javascript:void(0);"><img src="@/assets/images/layouts/layout-1/prod-3.jpg" class="img-fluid avatar-60 rounded-small" alt="image"></a>
							<div class="media-body ml-3">
								<h5>Hip Hop Hat</h5>
						...
						<li class="media align-items-center mt-3">
							<a href="javascript:void(0);"><img src="@/assets/images/layouts/layout-1/prod-4.jpg" class="img-fluid avatar-60 rounded-small" alt="image"></a>
							<div class="media-body ml-3">
								<h5>Sports Shoes</h5>
