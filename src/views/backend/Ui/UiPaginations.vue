              ...
              <div class="card">
                <kbd class="bg-dark">
                  <pre class="text-white" id="disabled-active-3">
                    <code>
&lt;b-pagination class="mm-page-primary" :value="2" :total-rows="50" /&gt;
&lt;b-pagination class="mm-page-success" :value="2" :total-rows="50" /&gt;
&lt;b-pagination class="mm-page-info" :value="2" :total-rows="50" /&gt;
</code></pre>
                </kbd>
              </div>
            </b-collapse>
...
export default {
  name: 'UiPagination',
  mounted () {
    const pageination = document.getElementsByClassName('mm-page-primary')[0]
    ...
    const pageinationSuccess = document.getElementsByClassName('mm-page-success')[0]
    ...
    const pageinationInfo = document.getElementsByClassName('mm-page-info')[0]
