    ...
    <b-row>
      <b-col lg="12">
        <div class="mm-accordion career-style faq-style  ">
          <card :class="`card mm-accordion-block ${index == 0 ? 'accordion-active' : ''}`" v-for="(item,index) in faqList" :key="index">
            <div class="clearfix">
              <div class="container">
                <b-row class="py-2" >
      ...
      <b-col lg="12">
        <div class="mm-accordion career-style faq-style  ">
          <card class="card mm-accordion-block" v-for="(item,index) in faqList" :key="index">
            <div class="clearfix">
              <div class="container">
                <b-row class="py-2">
...
export default {
  ...
  methods: {
    onCollapse (e) {
      ...
      const el = e.target.closest('.mm-accordion-block')
