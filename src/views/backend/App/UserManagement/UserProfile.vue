         ...
         <div class="card card-block">
            ...
            <div class="card-body">
               ...
               <div class="mm-progress-bar-linear d-inline-block w-100 mb-3">
                  ...
                  <Progressbar :value="90" midclass="mm-progress-bar" color="primary" class="mm-progress-bar pro-skill"/>
               </div>
               <div class="mm-progress-bar-linear d-inline-block w-100 mb-3">
                  <span>MySQl</span>
                  <span class="float-right">85%</span>
                  <Progressbar :value="85" midclass="mm-progress-bar" color="danger" class="mm-progress-bar pro-skill"/>
               </div>
               <div class="mm-progress-bar-linear d-inline-block w-100 mb-3">
                  <span>Node Js</span>
                  <span class="float-right">70%</span>
                  <Progressbar :value="70" midclass="mm-progress-bar" color="warning" class="mm-progress-bar pro-skill"/>
               </div>
               <div class="mm-progress-bar-linear d-inline-block w-100">
                  <span>Angular Js</span>
                  <span class="float-right">55%</span>
                  <Progressbar :value="55" midclass="mm-progress-bar" color="info" class="mm-progress-bar pro-skill"/>
               </div>
            </div>
         </div>
         <div class="card card-block">
