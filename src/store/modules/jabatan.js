//store/modules/jabatan.js
import instance from '../../config/axios'
import { showToast } from '../../_utils/toast'

export const getJabatanLists = () => {
  return instance.get('jabatan/semua')
  .then((data)=>{
...
export const postSaveJabatan = (data) => {
  return instance.post('jabatan/simpan', data)
    .then((respon) => {
...
export const postDeleteJabatan = (idJabatan) => {
  return instance.post('jabatan/hapus/' + idJabatan)
    .then((response) => {
