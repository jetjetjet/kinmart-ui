    ...
    <b-row>
      ...
      <b-col sm="12">
        ...
        <b-card-group columns>
          ...
          <b-card no-body class="mm-mb-3 text-center" bg-variant="primary" text-variant="white">
            <blockquote class="blockquote mb-0 card-body">
              <p class="font-size-14">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante.</p>
              <footer class="blockquote-footer">
          ...
          <b-card title="Card title" class="mm-mb-3 text-center">
          ...
          <b-card no-body class="mm-mb-3 text-right">
            <blockquote class="blockquote mb-0 card-body">
              <p class="font-size-14">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante.</p>
              <footer class="blockquote-footer">
                <small class="text-muted">Someone famous in <cite title="Source Title">Source Title</cite></small>
          ...
          <b-card title="Card title" class="mm-mb-3">
