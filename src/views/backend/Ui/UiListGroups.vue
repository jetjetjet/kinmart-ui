              ...
              <div class="card">
                <kbd class="bg-dark">
                  <pre class="text-white" id="with-badges-2">
                    <code>
&lt;b-list-group&gt;
  &lt;b-list-group-item class="d-flex justify-content-between align-items-center mm-bg-primary"&gt;
    Cras justo odio
    &lt;b-badge variant="primary" pill&gt;14&lt;/b-badge&gt;
  &lt;/b-list-group-item&gt;
  &lt;b-list-group-item class="d-flex justify-content-between align-items-center mm-bg-success"&gt;
    Dapibus ac facilisis in
    &lt;b-badge variant="success" pill&gt;2&lt;/b-badge&gt;
  &lt;/b-list-group-item&gt;
  &lt;b-list-group-item class="d-flex justify-content-between align-items-center mm-bg-danger"&gt;
    Morbi leo risus
    &lt;b-badge variant="danger" pill&gt;1&lt;/b-badge&gt;
  &lt;/b-list-group-item&gt;
&lt;/b-list-group&gt;
