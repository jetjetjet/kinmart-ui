                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="mm-cart-text">
                                <h2 class=""><b>500K</b></h2>
                                <p class="mb-0 text-danger">New Patient</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card card-block card-stretch card-height position-relative overflow-hidden card-overlay-image">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="mm-cart-image">
                                <svg width="62" height="57" viewBox="0 0 52 47" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                            ...
                            <div class="mm-cart-text">
                                <h2 class=""><b>250M</b></h2>
                                <p class="mb-0 text-success">Total Earning</p>
                            </div>
                        </div>
                    </div>
                    <div class="overlay-image svg-success">
                        <svg height="100%" viewBox="0 0 264 113" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M108.5 68C82.4829 96.2795 31.0226 108.712 4.54413 112H259C262.2 112 263.333 108.667 263.5 107V6C263.5 1.6 259.167 0.166667 257 0H192.5C172.1 3.2 128 46.6667 108.5 68Z" />
                        </svg>
                ...
                <div class="card card-block card-stretch card-height  position-relative overflow-hidden card-overlay-image">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="mm-cart-text">
                                <h2 class=""><b>350</b></h2>
                                <p class="mb-0 text-primary">Total Staff</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card card-block card-stretch card-height  position-relative overflow-hidden card-overlay-image">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="mm-cart-text">
                                <h2 class=""><b>500</b></h2>
                                <p class="mb-0 text-warning">Appointment</p>
                            </div>
                        </div>
                    </div>
                    <div class="overlay-image svg-primary">
            ...
            <div class="col-lg-6">
                <div class="card card-block card-stretch card-height">
                    ...
                    <div class="card-body">
                        ...
                        <!-- <ApexChart element="hospital-chart-02" :chartOption="chart1" /> -->
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="card card-block card-stretch card-height">
                    ...
                    <div class="card-body">
                        <ApexChart element="dash-chart-04" :chartOption="chart3" />
                        <!-- <div id="dash-chart-04"></div> -->
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                    ...
                    <div class="card-body">
                        <div class="media mb-3 align-items-center">
                            <div class="bg-primary-light rounded p-2">
                                <svg class="svg-icon svg-primary text-primary" width="42" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z" />
                                </svg>
                            </div>
                            <div class="media-body ml-3">
                                <h5 class="mt-0 font-weight-bold mb-1">Heart Stroke</h5>
                                <p class="text-ellipsis short-1 mb-0">Donec rutrum congue leo eget malesuada. Quisque velit nisi, pretium ut lacinia in, elementum id enim. Pellentesque in ipsum id orci porta dapibus.</p>
                            </div>
                        </div>
                        <div class="media mb-3 align-items-center">
                            <div class="bg-danger-light rounded p-2">
                                <svg class="svg-icon svg-danger text-danger" width="42" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <div class="media-body ml-3">
                                <h5 class="mt-0 font-weight-bold mb-1">Bliendness</h5>
                                <p class="text-ellipsis short-1 mb-0">Proin eget tortor risus. Curabitur non nulla sit amet nisl tempus convallis quis ac lectus. Sed porttitor lectus nibh.</p>
                            </div>
                        </div>
                        <div class="media mb-3 align-items-center">
                            <div class="bg-warning-light rounded p-2">
                                <svg class="svg-icon svg-warning text-warning" width="42" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <div class="media-body ml-3">
                                <h5 class="mt-0 font-weight-bold mb-1">kidney failure</h5>
                                <p class="text-ellipsis short-1 mb-0 mb-0">Sed porttitor lectus nibh. Vivamus magna justo, lacinia eget consectetur sed, convallis at tellus. Quisque velit nisi, pretium ut lacinia in, elementum id enim.</p>
                            </div>
                        </div>
                        <div class="media align-items-center">
                            <div class="bg-info-light rounded p-2">
                                <svg class="svg-icon svg-info text-info" width="42" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 11V9a2 2 0 00-2-2m2 4v4a2 2 0 104 0v-1m-4-3H9m2 0h4m6 1a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                            </div>
                            <div class="media-body ml-3">
                                <h5 class="mt-0 font-weight-bold mb-1">Paralysis</h5>
                                <p class="text-ellipsis short-1 mb-0 mb-0">Proin eget tortor risus. Curabitur non nulla sit amet nisl tempus convallis quis ac lectus. Sed porttitor lectus nibh.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-8 pt-3 pb-3">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="#"><i class="las la-star text-warning"></i></a>
                                    <a href="#"><i class="las la-star text-warning"></i></a>
                                    <a href="#"><i class="lar la-star text-warning"></i></a>
                                    <a href="#"><i class="lar la-star text-warning"></i></a>
                                </div>
                                <p class="mb-0">4.5 / 5</p>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-8 pt-3 pb-3">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="#"><i class="las la-star text-warning"></i></a>
                                    <a href="#"><i class="las la-star text-warning"></i></a>
                                    <a href="#"><i class="las la-star-half-alt text-warning"></i></a>
                                    <a href="#"><i class="lar la-star text-warning"></i></a>
                                </div>
                                <p class="mb-0">4.5 / 5</p>
                            </div>
            ...
            <div class="col-lg-4">
                <div class="card card-block card-stretch card-height">
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h4 class="card-title">Appointment Survey</h4>
                        </div>
                    </div>
                    <div class="card-body text-center">
                        <ApexChart element="hospital-chart-05" :chartOption="chart4" />
                        <!-- <div id="hospital-chart-05"></div> -->
                    </div>
                </div>
            </div>
                ...
                <div class="card  card-block card-stretch card-height">
                    ...
                    <div class="card-body ">
                        <div class="table-responsive">
                            <table id="datatable"  class="table mb-0 dataTable table-bordered data-tables">
                                <thead>
                                    <tr>
                                        <th>Name</th>
                                        <th>Date</th>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="mm-progress-bar-linear d-inline-block w-80">
                                                <Progressbar :value="75" midclass="mm-progress-bar" color="primary" class="mm-progress-bar"/>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="mm-progress-bar-linear d-inline-block w-80">
                                                <Progressbar :value="55" midclass="mm-progress-bar" color="primary" class="mm-progress-bar"/>
                                                <!-- <div class="mm-progress-bar">
                                        ...
                                        <td>
                                            <img src="@/assets/images/icon/pdf.png" class="img-fliud">
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="mm-progress-bar-linear d-inline-block w-80">
                                                <Progressbar :value="90" midclass="mm-progress-bar" color="primary" class="mm-progress-bar"/>
                                                <!-- <div class="mm-progress-bar">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="media align-items-center">
                                                <img src="@/assets/images/user/7.jpg" class="img-fluid avatar-35 rounded" alt="image">
                                                <div class="media-body ml-3">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="media align-items-center">
                                                <img src="@/assets/images/user/1.jpg" class="img-fluid avatar-35 rounded" alt="image">
                                                <div class="media-body ml-3">
                                        ...
                                        <td>
                                            <div class="mm-progress-bar-linear d-inline-block w-80">
                                                <Progressbar :value="70" midclass="mm-progress-bar" color="primary" class="mm-progress-bar"/>
                                                <!-- <div class="mm-progress-bar">
